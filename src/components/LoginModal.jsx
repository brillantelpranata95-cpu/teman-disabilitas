      ...
      <div className="bg-white rounded-3xl max-w-sm w-full shadow-2xl border border-slate-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-6 relative">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Login Superadmin</h2>
              <p className="text-xs text-slate-400">Kapanewon Temon</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleLogin} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white outline-none transition"
              />
            </div>
          </div>
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm rounded-xl transition shadow-md disabled:opacity-70 flex justify-center items-center"
            >
